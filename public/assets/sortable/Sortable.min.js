/*! Sortable 1.15.4 - MIT | git://github.com/SortableJS/Sortable.git */
!(function (t, e) {
    ...
    function F(t, e) {
        for (
            ...
            n &&
            (n === jt.ghost || "none" === R(n, "display") || (e && !f(n, e)));
        ...
        return {
            ...
            animateAll: function (t) {
                ...
                if (!this.options.animation)
                    return (
                        clearTimeout(e), void ("function" == typeof t && t())
                    );
                var u = !1,
                    d = 0;
    ...
    function jt(t, e) {
        ...
        var n,
            ...
            i = {
                ...
                supportPointer:
                    !1 !== jt.supportPointer && "PointerEvent" in window && !u,
            ...
            function A(t) {
                return (
                    ...
                    s.dragoverBubble ||
                        n.rootEl ||
                        l === document ||
                        (Z.parentNode[K]._isOutsideThisEl(n.target),
                        t || Bt(n)),
                    !s.dragoverBubble &&
                        n.stopPropagation &&
                        n.stopPropagation(),
        ...
        _onDrop: function (t) {
            ...
            (rt = j(Z)),
                ...
                jt.eventCanceled ||
                    ...
                    this.nativeDraggable &&
                        (p(document, "drop", this),
                        p(e, "dragstart", this._onDragStart)),
                    this._offMoveEvents(),
                    this._offUpEvents(),
                    ...
                    t &&
                        ...
                        Z &&
                            ...
                            mt &&
                                !Dt &&
                                k(Z, (ct || this).options.ghostClass, !1),
                        ...
                        (0 == T && 0 == f) ||
                            ...
                            (Qt[d].pid = setInterval(
                                function () {
                                    o &&
                                        0 === this.layer &&
                                        jt.active._onTouchMove(Zt);
                                    var t = Qt[this.layer].vy
                                            ? Qt[this.layer].vy * s
                                            : 0,
                                        e = Qt[this.layer].vx
                                            ? Qt[this.layer].vx * s
                ...
                return (
                    (t.prototype = {
                        ...
                        dragStartGlobal: function (t) {
                            ...
                            !this.isMultiDrag &&
                                le &&
                                le.multiDrag._deselectMultiDrag(),
                                de.forEach(function (t) {
                                    t.sortableIndex = j(t);
                                }),
