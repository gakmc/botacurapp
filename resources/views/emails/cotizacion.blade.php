...
<head>
    ...
    <title>Cotización Botacura</title>
</head>
...
<body style="background-color: #363636; color:aliceblue; font-family:Arial, Helvetica, sans-serif;">
    <div style="text-align: center;">
        ...
        <p style="text-align: center">Gracias por considerar realizar su evento junto a nosotros. <br>Te queremos compartir el detalle de este. Adjunto, encontrarás dicho detalle de la cotización solicitada. <br>Si tienes alguna consulta, no dudes en contactarnos.</p>
