...
<div class="section">
    <p class="caption"><strong>Cierre de caja</strong></p>
                    ...
                    <div class="row">
                        ...
                        <table class="responsive-table">
                            ...
                            <tbody>
                                ...
                                $totalDiferencia = ($venta->pendiente_de_pago) ? $venta->total_pagar :
                                $venta->diferencia_programa;
                                ...
                                @endphp
                                <tr>
                                    <td><a href="{{route("backoffice.reserva.show",$venta->reserva->id)}}">{{$venta->reserva->cliente->nombre_cliente}}</a>
                                    </td>

                                    @if ($venta->pendiente_de_pago)
                                    <td>
                                        <a class="btn-small disabled"><span class="red-text">Por Pagar</span><i
                                                class='material-icons red-text right '>cancel</i></a>
                                    </td>
                                    @else
                                    <td class="green-text">
                                        <a class="btn-small disabled"><span class="green-text">Pagado</span><i
                                                class='material-icons green-text right '>check_circle</i></a>
                                    </td>
                                    @endif
                                    ...
                                    <td>
                                        ${{ number_format(optional(optional($venta->consumo)->propina)->cantidad ?? 0,
                                        0, ',', '.') }}
                                    </td>
                                    ...
                                    @endphp
                                    <td>${{ number_format($consumoSinPropina+$totalDiferencia+$serviciosSinPropina, 0,
                                        ',', '.') }}</td>
                                    <td>${{
                                        number_format($consumoSinPropina+$totalDiferencia+$serviciosSinPropina+$propinaReal,
                                        0, ',', '.') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="col s12 m3">
                            ...
                            <table class="striped centered">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    $contratado = ($programa->total_programas == 0 || $programa->total_programas > 1) ?
                            ...
                            <table class="striped bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="white-text" style="background-color: #039B7B">Propina Venta Directa</th>{{--
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${{
                                            number_format($transaccion->total_diferencias+$transaccion->venta_directa+$transaccion->poro_poro,0,'','.')
                                            }}</td>
                                        <td>${{ number_format($transaccion->propinaDirecta,0,'','.') }}</td>{{-- 
                                ...
                                {{-- <tr>
                                    ...
                                    <td><strong>${{
                                            number_format($tiposTransacciones->sum("total_diferencias"),0,'','.')
                                            }}</strong></td>
                                    <td><strong>${{ number_format($tiposTransacciones->sum("venta_directa"),0,'','.')
                                            }}</strong></td>
                                    <td><strong>${{ number_format($tiposTransacciones->sum("poro_poro"),0,'','.')
                                            }}</strong></td>
                                </tr> --}}
                                <tr>
                                    <td></td>
                                    ...
                                    <td><strong>${{
                                            number_format($tiposTransacciones->sum("total_diferencias")+$tiposTransacciones->sum("venta_directa")+$tiposTransacciones->sum("propinaDirecta")+$tiposTransacciones->sum("poro_poro"),0,'','.')
                                            }}</strong></td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table class="striped bordered">
                                ...
                                <tbody>
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td>
                                            ${{number_format($totalPosiblePropina+($ventaDirectaTotalPropina ??
                                            0),0,'','.')}}
                                        </td>
                                    </tr> --}}
                                    <tr>
