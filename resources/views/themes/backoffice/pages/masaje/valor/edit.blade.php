            ...
            <div class="col s12 m8 offset-m2">
                <div class="card-panel">
                    ...
                    <div class="row">
                        ...
                        {{-- CONTENIDO --}}
                        <form action="{{route('backoffice.masajes.valores.update', $precio)}}" method="POST" class="col s12">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6">
                                  <select name="id_tipo_masaje" id="id_tipo_masaje">
                                      ...
                                      <option value="{{ $tipo->id }}" {{ old('id_tipo_masaje') ?? $precio->id_tipo_masaje == $tipo->id ? 'selected' : '' }}>{{ $tipo->nombre }}
                                      </option>
                                      @endforeach
                                  </select>
                                ...
                                <div class="input-field col s12 m6">
                                  <input id="duracion_minutos" type="text" name="duracion_minutos" value="{{ old('duracion_minutos') ?? $precio->duracion_minutos }}">
                            ...
                            <div class="row">
                                <div class="input-field col s12 m6 l4">
                                  <input id="precio_unitario" type="text" name="precio_unitario" value="{{ old('precio_unitario') ?? '$'.number_format($precio->precio_unitario, 0,',','.')  }}">
                                ...
                                <div class="input-field col s12 m6 l4">
                                  <input id="precio_pareja" type="text" name="precio_pareja" value="{{ old('precio_pareja') ?? '$'.number_format($precio->precio_pareja, 0,',','.')  }}">
                                ...
                                <div class="input-field col s12 m6 l4">
                                  <input id="pago_masoterapeuta" type="text" name="pago_masoterapeuta" value="{{ old('pago_masoterapeuta') ?? '$'.number_format($precio->pago_masoterapeuta, 0,',','.')  }}">
