                    ...
                    <div class="row">
                        ...
                        <form class="col s12" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l2" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display: none;" @endif>
                                ...
                                {{-- CATEGORÍA --}}
<div class="input-field col s12 m6 l4" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="categoria_masaje" name="masaje[categoria_slug]" @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Categoría --</option>
    @foreach($catalogoMasajes as $cat)
      <option value="{{ $cat['slug'] }}" {{ old("masaje.categoria_slug")==$cat['slug'] ? 'selected' : '' }}>
        {{ $cat['nombre'] }}
      </option>
    @endforeach
  </select>
  <label for="categoria_masaje">Categoría de masaje</label>
</div>

{{-- TIPO --}}
<div class="input-field col s12 m6 l4" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="tipo_masaje" name="masaje[tipo_slug]" disabled @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Tipo --</option>
  </select>
  <label for="tipo_masaje">Tipo de masaje</label>
</div>

{{-- DURACIÓN / PRECIO (elige la fila de precios_tipos_masajes) --}}
<div class="input-field col s12 m6 l4" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="precio_masaje" name="masaje[precio_id]" disabled @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Duración / Precio --</option>
  </select>
  <label for="precio_masaje">Duración</label>

  {{-- info visual opcional --}}
  <small id="info_precio_masaje" class="grey-text"></small>
</div>
                ...
                <div class="row">
                            ...
                            {{-- CATEGORÍA --}}
<div class="input-field col s12 m6 l2" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="categoria_masaje_{{$i}}" name="masajes[{{$i}}][categoria_slug]" @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Categoría --</option>
    @foreach($catalogoMasajes as $cat)
      <option value="{{ $cat['slug'] }}" {{ old("masajes.$i.categoria_slug")==$cat['slug'] ? 'selected' : '' }}>
        {{ $cat['nombre'] }}
      </option>
    @endforeach
  </select>
  <label for="categoria_masaje_{{$i}}">Categoría de masaje</label>
</div>

{{-- TIPO --}}
<div class="input-field col s12 m6 l2" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="tipo_masaje_{{$i}}" name="masajes[{{$i}}][tipo_slug]" disabled @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Tipo --</option>
  </select>
  <label for="tipo_masaje_{{$i}}">Tipo de masaje</label>
</div>

{{-- DURACIÓN / PRECIO (elige la fila de precios_tipos_masajes) --}}
<div class="input-field col s12 m6 l2" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display:none;" @endif>
  <select id="precio_masaje_{{$i}}" name="masajes[{{$i}}][precio_id]" disabled @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
    <option value="" disabled selected>-- Duración / Precio --</option>
  </select>
        ...
        <div class="row">
                                ...
                                {{-- <div class="input-field col s12 m6 l4" @if(!in_array('Masaje', $servicios) && !$masajesExtra) style="display: none;" @endif>
                                    ...
                                    <select id="tipo_masaje_{{$i}}" name="masajes[{{$i}}][tipo_masaje]" @if(!in_array('Masaje', $servicios) && !$masajesExtra) disabled hidden @endif>
                                        ...
                                        <option value="" disabled selected>-- Seleccione --</option>
                                        <option value="Relajación" {{ old("masajes.{$i}.tipo_masaje")=='Relajación' ? 'selected' : '' }}>Relajación</option>
                                        <option value="Descontracturante" {{ old("masajes.{$i}.tipo_masaje")=='Descontracturante' ? 'selected' : '' }}>Descontracturante</option>
