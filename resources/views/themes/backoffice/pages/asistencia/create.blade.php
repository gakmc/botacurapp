...
@section('breadcrumbs')
<li><a href="{{route('backoffice.asignacion.index')}}">Registrar asistencia</a></li>
@endsection
...
@section('content')
<div class="section">
    <p class="caption"><strong>Asistencias</strong></p>
        ...
        <div class="row">
            <div class="col s12 m8 offset-m2 ">
                ...
                <div class="card-panel">
                    <h4 class="header2">Seleccione asistentes para fecha <strong>{{ $fecha }}</strong></h4>
                    <div class="row">
                        <form class="col s12" method="post" action="{{route('backoffice.asistencia.store')}}">
