    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        @foreach($eventosAgrupados as $fecha => $data)
            ...
            eventos.push({
                ...
                @if (isset($data['reserva']->venta) && $data['reserva']->venta->total_pagar <= 0 && is_null($data['reserva']->venta->diferencia_programa))
                    color: 'orange'
                @elseif ($data['reserva']->venta->total_pagar <= 0 && !is_null($data['reserva']->venta->diferencia_programa))
                    color: 'green'
                @else
                    color: 'primary'
                @endif
