@if ($mobileView == 'masajes')
        ...
        <div class="col s12 hide-on-large-only">
            ...
            <div class="col s12 m6 reserva-card" data-tipo="sauna">
                ...
                <table class="">
                    ...
                    <tbody>
                                            ...
                                            @php
                                                ...
                                                foreach ($reserva->visitas->sortBy('id_ubicacion') as $horario => $visita) {
                                                    ...
                                                    if ($visita->masajes->isEmpty()) {
                                                        ...
                                                        $horariosMasaje = $visita->masajes->pluck('horario_masaje')->filter()->unique()->join(', ');
                                                    }
                                                }
                                        ...
                                        <tr>
                                            <td>
                                                {{ ($horariosMasaje != '') ? $horariosMasaje : 'No Registra' }}
                                            </td>
                                            <td>
                                                {{ ($horariosMasaje != '') ? $horariosMasaje : 'No Registra' }}
                                            </td>
                                            <td>
                                                {{ ($horariosMasaje != '') ? $reserva->cantidad_personas : 'No Registra' }}
                                            </td>
                                            <td>
                                                {{ ($horariosMasaje != '') ? $reserva->cliente->nombre_cliente : 'No Registra' }}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
        ...
        <table class="">
            ...
            <tbody>
                        ...
                        @endphp
                                <tr>
                                    <td>
                                        {{ ($horariosSauna != '') ? $horariosSauna : 'No Registra' }}
                                    </td>
                                    <td>
                                        {{ ($horariosSauna != '') ? $visita->hora_fin_sauna : 'No Registra' }}
                                    </td>
                                    <td>
