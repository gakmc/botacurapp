...
<body>
    <div class="ticket">
        <img src="{{ public_path('images/botacura/logo.png') }}" alt="botacura logo" style="max-height: 125px; max-width:125px; padding:0px; margin:0px"/>
                ...
                @foreach($listaConsumos as $detalle)
                    ...
                    <tr>
                        <td style="text-align: left; padding-right: 5px; word-wrap: break-word; max-width: 70%;">
                            {{ $detalle->poro->nombre}} (${{number_format($detalle->precio_unitario,0,'','.')}}) X {{ $detalle->cantidad }}
                        </td>
